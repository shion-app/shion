/*
  ...
  - Added the required column `box_id` to the `moment` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_moment" (
    ...
    CONSTRAINT "moment_link_id_fkey" FOREIGN KEY ("link_id") REFERENCES "link" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
